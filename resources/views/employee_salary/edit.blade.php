...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="/employee_salary/{{ $emp_salary->id }}">
                    @method('put')
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-control" name="salary_id">
                            @foreach ($salaries as $item)
                                @if ($emp_salary->salary_id == $item->id)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-control" name="deduction_id">
                            @foreach ($deductions as $item)
                                @if ($emp_salary->deduction_id == $item->id)
                    ...
                    <div class="mb-3">
                        ...
                        <input type="month"
                            class="form-control @error('period')
                                is-invalid
                            @enderror"
                            id="period" name="period" value="{{ $emp_salary->period, old('period') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number"
                            class="form-control @error('emp_presence')
                                is-invalid
                            @enderror"
                            id="emp_presence" name="emp_presence" autofocus
                            value="{{ $emp_salary->emp_presence, old('emp_presence') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number"
                            class="form-control @error('emp_non_presence')
                                is-invalid
                            @enderror"
                            id="emp_non_presence" name="emp_non_presence" autofocus
                            value="{{ $emp_salary->emp_non_presence, old('emp_non_presence') }}">
