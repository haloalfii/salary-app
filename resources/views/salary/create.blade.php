    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Add Salary Data</h6>
            </div>
            <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            class="form-control @error('salary_code')
                                is-invalid
                            @enderror"
                            id="salary_code" name="salary_code" autofocus value="{{ old('salary_code') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number"
                            class="form-control @error('base_salary')
                                is-invalid
                            @enderror"
                            id="base_salary" name="base_salary" autofocus value="{{ old('base_salary') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number"
                            class="form-control @error('presence_salary')
                                is-invalid
                            @enderror"
                            id="presence_salary" name="presence_salary" autofocus value="{{ old('presence_salary') }}">
